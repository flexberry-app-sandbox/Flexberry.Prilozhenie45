...
namespace IIS.Prilozhenie_4
{
    ...
    public class Контроллер : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_4.Сенсоры fСенсоры;
        
        private IIS.Prilozhenie_4.Серверная fСерверная;
        ...
        [PropertyStorage(new string[] {
                "Сенсоры"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_4.Сенсоры Сенсоры
        {
            get
            {
                ...
                IIS.Prilozhenie_4.Сенсоры result = this.fСенсоры;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Prilozhenie_4.Серверная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Серверная"})]
        public virtual IIS.Prilozhenie_4.Серверная Серверная
        {
            get
            {
                ...
                IIS.Prilozhenie_4.Серверная result = this.fСерверная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтроллерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтроллерE", typeof(IIS.Prilozhenie_4.Контроллер));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтроллер : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Prilozhenie_4.DetailArrayOfКонтроллер members)

        // *** End programmer edit section *** (IIS.Prilozhenie_4.DetailArrayOfКонтроллер members)
        ...
        /// </summary>
        public DetailArrayOfКонтроллер(IIS.Prilozhenie_4.Серверная fСерверная) : 
                base(typeof(Контроллер), ((ICSSoft.STORMNET.DataObject)(fСерверная)))
        {
        }
        
        public IIS.Prilozhenie_4.Контроллер this[int index]
        {
            get
            {
                return ((IIS.Prilozhenie_4.Контроллер)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Prilozhenie_4.Контроллер dataobject)
        {
