    ...
    public class Сенсоры : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СенсорыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СенсорыE", typeof(IIS.Prilozhenie_4.Сенсоры));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СенсорыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СенсорыL", typeof(IIS.Prilozhenie_4.Сенсоры));
                }
            }
        }
    }
