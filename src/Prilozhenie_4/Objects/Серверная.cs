...
namespace IIS.Prilozhenie_4
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_4.Сотрудник fСотрудник;
        
        private IIS.Prilozhenie_4.DetailArrayOfКонтроллер fКонтроллер;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_4.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Prilozhenie_4.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Prilozhenie_4.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.Prilozhenie_4.DetailArrayOfКонтроллер(this);
                }
                IIS.Prilozhenie_4.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.Prilozhenie_4.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.Prilozhenie_4.Серверная));
                }
            }
        }
    }
