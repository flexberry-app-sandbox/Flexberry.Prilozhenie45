...
namespace IIS.Prilozhenie_4
{
    ...
    [View("ОтчетОСервереE", new string[] {
            "Режим as \'Режим\'",
            "Расположение.Адрес as \'Расположение\'",
            "Серверная as \'Сервер\'"})]
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_4.РежимСервера fРежим;
        
        private IIS.Prilozhenie_4.Серверная fСерверная;
        
        private IIS.Prilozhenie_4.Расположение fРасположение;
        ...
        public virtual IIS.Prilozhenie_4.РежимСервера Режим
        {
            get
            {
                ...
                IIS.Prilozhenie_4.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_4.Расположение Расположение
        {
            get
            {
                ...
                IIS.Prilozhenie_4.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.Prilozhenie_4.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.Prilozhenie_4.ОтчетОСервере));
                }
            }
        }
    }
